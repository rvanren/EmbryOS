...
mode.  The short assembly program in Listing~\ref{lst:start_s} defines the entry
...
\lstinputlisting[style=oscode,language={[x86masm]Assembler},caption={Startup assembly for EmbryOS},label={lst:start_s}]{../code/chapter1/start.s}
\end{minipage}
\end{figure}
